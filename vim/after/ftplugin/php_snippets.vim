...
exec "Snippet class // {{{ ".st."ClassName".et." Class<CR>/**<CR>* ".st.et."<CR>*/<CR>class ".st."ClassName".et." ".st.et."<CR>{<CR>".st.et."<CR>}<CR>// }}}<CR>".st.et
...
exec "Snippet function // {{{ ".st."FunctionName".et."<CR>/**<CR>* ".st.et."<CR>*/<CR>".st."public".et." function ".st."FunctionName".et." (".st.et.")<CR>{<CR>".st.et."<CR>}<CR>//}}}<CR>".st.et
