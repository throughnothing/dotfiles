...
exec "Snippet def #{{{ ".st."fname".et."<CR>def ".st."fname".et."(".st."args:PyCleanupArgs(@z)".et."):
\<CR>\"\"\"
\<CR>".st.et."
...
" Class definition.
exec "Snippet class #{{{ class ".st."ClassName".et."<CR>
\class ".st."ClassName".et."(".st."object".et."):
\<CR>\"\"\"
